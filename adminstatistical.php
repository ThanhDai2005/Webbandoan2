        ...
        <div class="admin-control">
            ...
            <div class="admin-control-center">
                <form action="" class="form-search" method="GET">
                    <span onclick="this.parentNode.submit();" class="search-btn"><i
                            class="fa-light fa-magnifying-glass"></i></span>
                    <input id="form-search-tk" name="search" type="text" class="form-search-input"
                        placeholder="Tìm kiếm tên khách hàng..." value="<?php echo htmlspecialchars($search); ?>" />
            ...
            <div class="admin-control-right">
                ...
                <a href="?sort=1&search=<?php echo urlencode($search); ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>"
                    class="reset-order">
                    <i class="fa-regular fa-arrow-up-short-wide"></i>
                </a>
                <a href="?sort=2&search=<?php echo urlencode($search); ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>"
                    class="reset-order">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="order-statistical-item">
                        <div class="order-statistical-item-content">
                            ...
                            <h4 class="order-statistical-item-content-h">
                                <?php echo number_format($total_revenue, 0, ',', '.'); ?> ₫</h4>
                        </div>
                        <div class="order-statistical-item-icon">
                ...
                <tbody id="showTk">
                    <?php foreach ($paginated_customers as $index => $customer): ?>
                        <tr>
                            ...
                            <td>
                                <a href="adminthongkechitiet.php?customerId=<?php echo $customer['customerId']; ?>"
                                    class="btn-detail">
