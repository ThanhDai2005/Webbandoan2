    ...
    <div class="adminthongkechitiet">
      <div class="admin-control">
        <div class="admin-control-center">
          <form action="" class="form-search" method="GET">
            ...
            <input id="form-search-tk" name="search" type="text" class="form-search-input"
              placeholder="Tìm kiếm hóa đơn..." value="<?php echo htmlspecialchars($search); ?>" />
        ...
        <div class="admin-control-right">
          ...
          <a href="?customerId=<?php echo $customerId; ?>&sort=1&search=<?php echo urlencode($search); ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>"
            class="reset-order">
            <i class="fa-regular fa-arrow-up-short-wide"></i>
          </a>
          <a href="?customerId=<?php echo $customerId; ?>&sort=2&search=<?php echo urlencode($search); ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>"
            class="reset-order">
